    ...
    <footer className="footer section bd-container">
      <div className="footer_container bd-grid">
        ...
        <div className="footer_content">
          ...
          <ul>
            <li>
              <MdLocationOn className="contact_info" /> 123 Main st. Toront, ON
            </li>
            <li>
              <AiFillMail className="contact_info" /> info@email.com
            </li>
            <li>
              <AiFillPhone className="contact_info" /> (647)442-9832
            </li>
          </ul>
        </div>
      </div>
